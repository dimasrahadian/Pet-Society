        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <li><a class="dropdown-item" href="mitrapro">Product Store</a></li>
                <li><a class="dropdown-item" href="mitrapet">Pet Sitting</a></li>
                <li><a class="dropdown-item" href="doctor">Vet Service</a></li>
              </ul>
            </li>
            <li class="nav-item">
